...
public class ChinhSuaKiChiTieu extends AppCompatActivity {
    Util util = new Util();
    int StatusCode;
    int ERR=0;
    ...
    private kychitieu current_kychitieu;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chinh_sua_ki_chi_tieu);
        Intent i = getIntent();
        Gson gson = new Gson();
        current_kychitieu = gson.fromJson(i.getStringExtra("kychitieu"),kychitieu.class);
        getComponentByID();
        addControls();
    ...
    private void addControls() {
        ...
        txtTenKyChiTieu.setText(current_kychitieu.getTenkychitieu());
        txtHanmucchitieu.setText(String.valueOf(current_kychitieu.getHanmucchitieu()));
        mDateDisplayTo.setText(util.DateStringByFormat(current_kychitieu.getTungay(),"dd/MM/yyyy"));
        mDateDisplayFrom.setText(util.DateStringByFormat(current_kychitieu.getDenngay(),"dd/MM/yyyy"));
        ...
        btnThemKyChiTieu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ERR == 0){
                    //TODO: Update ky chi tieu;
                    new updateKyChiTieuTask().execute();
                }
                else{
                    ERR = 0;
                }
    ...
    public void setSpinnerAdapter(){
        ...
        spNhomChiTieu.setSelection(spinnerAdapter.getPositionById(current_kychitieu.getNhomchitieu().getManhomchitieu()));
    ...
    public void GetInputKyChiTieu() throws ParseException {
        ...
        new_kychitieu = new kychitieu(txtTenKyChiTieu.getText().toString(),
                ...
                NhomChiTieu);
        new_kychitieu.setMakychitieu(current_kychitieu.getMakychitieu());
    }


    //TODO: insert new Giao dich
    public class  updateKyChiTieuTask extends AsyncTask<String, Void, Boolean> {
...
//                Thread.sleep(2000);
                ...
                Call<Void> call = service.update(new_kychitieu);
                call.enqueue(new Callback<Void>() {
                    ...
                    public void onResponse(Call<Void> call, Response<Void> response) {
                        ...
                        if(StatusCode == 200){
                            ...
                            showProgress(false);
                            Toast.makeText(getApplicationContext(), "Chỉnh sửa thất bại !", Toast.LENGTH_SHORT).show();
                        }
                    }
...
//            case R.id.remove:
//                new deleteKyChiTieuTask().execute();
//                return true;
//            default:
...
//    //TODO: insert new Giao dich
//    public class  deleteKyChiTieuTask extends AsyncTask<String, Void, Boolean> {
//
//        @Override
//        protected void onPreExecute() {
//            showProgress(true);
...
//            try {
//                KyChiTieu_Service service = RetrofitClientInstance.getRetrofitInstance().create(KyChiTieu_Service.class);
//                Call<Void> call = service.delete(current_kychitieu.getMakychitieu());
//                call.enqueue(new Callback<Void>() {
//                    @Override
//                    public void onResponse(Call<Void> call, Response<Void> response) {
//                        StatusCode = response.code();
...
//            }
//            finally {
//                util.setFlagNewGiaoDich(getApplicationContext(),true, current_kychitieu.getMakychitieu());
//            }
//            return (StatusCode == 200)? true : false;
//        }
//
